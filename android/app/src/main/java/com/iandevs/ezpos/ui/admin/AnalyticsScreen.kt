...
import com.iandevs.ezpos.data.dao.DailySalesSummary
import com.iandevs.ezpos.data.dao.TopProduct
        ...
        item {
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                MetricCard(
                    ...
                    value = analytics.todayRevenue.formatPeso(),
                ...
                MetricCard(
                    title = "Total Revenue",
                    value = analytics.totalRevenue.formatPeso(),
        ...
        item {
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                MetricCard(
                    ...
                    value = analytics.averageTransaction.formatPeso(),
                    subtitle = "per sale",
...
private fun TopProductRow(product: TopProduct) {
    Card(
        ...
        Row(
            ...
            Text(product.totalRevenue.formatPeso(), style = MaterialTheme.typography.bodyMedium, fontWeight = FontWeight.Bold, color = MaterialTheme.colorScheme.primary)
        }
    }
}

@Composable
private fun DaySummaryRow(day: DailySalesSummary) {
    Card(
        shape = RoundedCornerShape(12.dp),
        colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surface),
        border = CardDefaults.outlinedCardBorder()
        ...
        Row(
            ...
            Text(day.revenue.formatPeso(), style = MaterialTheme.typography.bodyMedium, fontWeight = FontWeight.Bold, color = MaterialTheme.colorScheme.primary)
        }
    }
}
