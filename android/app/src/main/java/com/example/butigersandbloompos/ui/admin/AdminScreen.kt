...
fun AdminScreen(
    ...
    onAddProduct: () -> Unit,
    onEditProduct: (com.example.butigersandbloompos.data.entity.Product) -> Unit,
    onDeleteProduct: (com.example.butigersandbloompos.data.entity.Product) -> Unit,
    onReorderProducts: (List<com.example.butigersandbloompos.data.entity.Product>) -> Unit,
